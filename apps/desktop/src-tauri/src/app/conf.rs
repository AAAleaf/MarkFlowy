...
pub_struct!(AppConf {
    ...
    upload_image_remote_service: Option<String>,
    upload_image_remote_path_prefix: Option<String>,
    upload_image_aliyun_access_key_id: Option<String>,
    upload_image_aliyun_access_key_secret: Option<String>,
    upload_image_aliyun_bucket: Option<String>,
    upload_image_aliyun_region: Option<String>,
    upload_image_aliyun_custom_domain: Option<String>,
    upload_image_github_token: Option<String>,
    upload_image_github_repo: Option<String>,
    upload_image_github_branch: Option<String>,
    upload_image_cos_secret_id: Option<String>,
    upload_image_cos_secret_key: Option<String>,
    upload_image_cos_bucket: Option<String>,
    upload_image_cos_region: Option<String>,
    upload_image_cos_custom_domain: Option<String>,
...
impl AppConf {
    ...
    pub fn new() -> Self {
        Self {
            ...
            upload_image_remote_service: Some("aliyun_oss".to_string()),
            upload_image_remote_path_prefix: Some("images".to_string()),
            upload_image_aliyun_access_key_id: Some("".to_string()),
            upload_image_aliyun_access_key_secret: Some("".to_string()),
            upload_image_aliyun_bucket: Some("".to_string()),
            upload_image_aliyun_region: Some("oss-cn-hangzhou".to_string()),
            upload_image_aliyun_custom_domain: Some("".to_string()),
            upload_image_github_token: Some("".to_string()),
            upload_image_github_repo: Some("".to_string()),
            upload_image_github_branch: Some("main".to_string()),
            upload_image_cos_secret_id: Some("".to_string()),
            upload_image_cos_secret_key: Some("".to_string()),
            upload_image_cos_bucket: Some("".to_string()),
            upload_image_cos_region: Some("ap-guangzhou".to_string()),
            upload_image_cos_custom_domain: Some("".to_string()),
    ...
    pub fn merge_conf(mut self, oldconf: AppConf, app: &AppHandle) -> Self {
        merge_options!(
            ...
            upload_image_remote_service,
            upload_image_remote_path_prefix,
            upload_image_aliyun_access_key_id,
            upload_image_aliyun_access_key_secret,
            upload_image_aliyun_bucket,
            upload_image_aliyun_region,
            upload_image_aliyun_custom_domain,
            upload_image_github_token,
            upload_image_github_repo,
            upload_image_github_branch,
            upload_image_cos_secret_id,
            upload_image_cos_secret_key,
            upload_image_cos_bucket,
            upload_image_cos_region,
            upload_image_cos_custom_domain,
            dialog_preferences
        );
